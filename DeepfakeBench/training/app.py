...
def startup_event() -> None:
    ...
    cfg_path = Path("training/config/detector/effort.yaml")
    weights_path = Path("training/weights/effort_clip_L14_trainOn_FaceForensic.pth")
    landmark_path = Path("preprocessing/shape_predictor_81_face_landmarks.dat")
