...
> - [`thread_template.md`](thread_template.md) / [`packet_template.md`](packet_template.md) — canonical formats.
...
> - [`BUILD_SCAFFOLD.md`](BUILD_SCAFFOLD.md) — chronological build map for slice agents (build-time; can be archived once all slices done).
...
[`packet_template.md`](packet_template.md) — the structure every packet file follows.
